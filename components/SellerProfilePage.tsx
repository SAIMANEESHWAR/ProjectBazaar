...
const SellerProfilePage: React.FC<SellerProfilePageProps> = ({ seller, sellerProjects: initialProjects, onBack }) => {
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1">
              ...
              {/* Social Links */}
              {(sellerData.githubUrl || sellerData.linkedinUrl) && (
                <div className="flex items-center gap-4 mb-4">
                  {sellerData.githubUrl && (
                    <a
                      href={sellerData.githubUrl}
                      target="_blank"
                  ...
                  {sellerData.linkedinUrl && (
                    <a
                      href={sellerData.linkedinUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-colors"
                    >
