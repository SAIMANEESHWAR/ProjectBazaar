  ...
  return (
    <div className="min-h-screen overflow-x-hidden transition-colors duration-300 font-sans bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-gray-100">
      ...
      <main className="pt-24 md:pt-28 pb-8">
        <div className="max-w-[1400px] mx-auto px-5 md:px-8 mb-6">
          <button
            type="button"
            onClick={() => navigateTo(isLoggedIn ? 'dashboard' : 'home')}
            className="inline-flex items-center gap-2 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-[#ff7a00] transition-colors"
          >
        ...
        <section ref={ref} className="relative py-6 md:py-12 overflow-hidden">
          <div className="relative max-w-[1400px] mx-auto px-5 md:px-8">
            ...
            >
              <div className="inline-flex items-center justify-center gap-2 mb-4">
                <Crown className="h-5 w-5 text-[#ff7a00]" aria-hidden />
                <p className="text-gray-500 dark:text-[#a1a1a1] uppercase tracking-[0.2em] text-sm font-semibold">
                  Pricing
                </p>
              </div>
            ...
            <motion.p
              ...
              className="mt-10 text-center text-sm text-gray-500 dark:text-gray-400 max-w-xl mx-auto leading-relaxed"
            >
