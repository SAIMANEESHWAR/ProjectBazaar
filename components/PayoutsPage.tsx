        ...
        <div className="mt-8 space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-1">
                    <div className="bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl p-6 h-full flex flex-col justify-between">
                        <div>
                            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Available Balance</p>
                            <p className="text-4xl font-bold text-gray-900 dark:text-white mt-2">$1,600.00</p>
                            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Next payout on July 15, 2024</p>
                        </div>
                ...
                <div className="md:col-span-2">
                     <div className="bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl p-6 h-full">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Payout Method</h3>
                        <div className="mt-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                <BankIcon />
                                <div>
                                    <p className="font-medium text-gray-800 dark:text-gray-200">Bank of Example</p>
                        ...
                        <button className="mt-4 text-sm font-medium text-blue-600 dark:text-blue-400 hover:underline">+ Add new payout method</button>
                    </div>
                </div>
            </div>

            <div className="bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white p-6">Payout History</h3>
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                        ...
                        <tbody className="bg-white dark:bg-gray-900/50 divide-y divide-gray-200 dark:divide-gray-800">
                            {payoutHistory.map((payout) => (
                                <tr key={payout.id}>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{payout.date}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-800 dark:text-gray-200">${payout.amount.toFixed(2)}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{payout.method}</td>
