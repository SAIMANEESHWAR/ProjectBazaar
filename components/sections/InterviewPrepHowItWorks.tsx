...
const InterviewPrepHowItWorks: React.FC = () => {
    return (
        <section className="py-8 md:py-10 bg-[#faf9f6] dark:bg-[#0a0a0a] transition-colors duration-300" id="how-it-works">
            <div className="container mx-auto px-6 max-w-[1200px]">
                {/* Header Section */}
                <div className="text-center mb-6 md:mb-8">
                    <h2 className="text-4xl md:text-5xl font-bold text-[#1f2937] dark:text-white mb-3">How it works</h2>
                ...
                <div className="flex flex-col gap-6 md:gap-8 lg:gap-10 relative">
                    {STEPS.map((step, index) => {
                        ...
                        return (
                            <div key={step.id} className={`flex flex-col ${isEven ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-start gap-5 lg:gap-8 relative z-10 py-2 md:py-3`}>
                                {/* Text Column */}
                                ...
                                <div className="lg:w-[55%] flex justify-center items-center w-full relative min-h-[200px] sm:min-h-[220px] lg:min-h-[240px] overflow-visible">
